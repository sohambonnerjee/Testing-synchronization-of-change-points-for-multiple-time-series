...
## For the rows "n=500", change n in Line 155. 
row.sum<-function(x){
...
r1<- seq(0,0.1, by=0.02) ;
r2<- r1
pow_mat<-matrix(0,nrow=6, ncol=6)
...
write.table(pow_mat, file = "table3.txt", row.names = FALSE, col.names = FALSE)
